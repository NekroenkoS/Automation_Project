...
class TestElectron:
    ...
    @allure.title("Test 2 - Verify task deleted successfully")
    @allure.description("This test verifies that the task is deleted successfully successfully")
    def test_02_verify_task_created(self):
        task_name = "Complete an hour of study"
        ElectronFlows.step_create_task(task_name)
        ElectronFlows.step_delete_upper_task()
        ElectronFlows.verify_task_list_empty()


    @allure.title("Test 3 - Verify multiple tasks created successfully")
    @allure.description("This test verifies that the amount of tasks we entered were created successfully")
    def test_03_verify_multiple_tasks_created(self):
    ...
    @allure.title("Test 4 - Verify multiple colored tasks created successfully")
    @allure.description(
        "This test verifies that the amount of tasks we entered were created successfully with the selected color")
    def test_04_verify_multiple_colored_tasks_created(self):
    ...
    @allure.title("Test 5 - Verify filter all displays tasks from all dates")
    @allure.description("This test verifies that the 'ALL' filter displays all tasks from all dates")
    def test_05_verify_all_filter(self):
        task_names = ["Read a book", "Complete an hour of study", "Buy milk"]
        ElectronFlows.step_delete_all_tasks()
        ElectronFlows.step_create_multiple_tasks(task_names)
